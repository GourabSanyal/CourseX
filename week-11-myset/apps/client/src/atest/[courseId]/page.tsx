...
function singleCoursePage({params} : {
  ...
  const currentCourseId  = params.courseId || routerQuery.query;
  const router = useRouterNavigation();
  console.log("course id from dynamic route --> ", currentCourseId);
  ...
  const getSingleCourse = async () => {
    ...
    console.log("course id from ui --> ", data);
  ...
  // console.log("single course -->", courseId);
